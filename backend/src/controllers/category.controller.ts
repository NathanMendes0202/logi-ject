...
import { categoryCreateSchema, categoryUpdateSchema, listQuerySchema } from "../schemas/catalog.schemas.js";
...
export async function index(req: AuthRequest, res: Response) {
  ...
  const result = await listCategories(q.page, q.limit, q.search, q.active === undefined ? undefined : q.active === "true");
